...
// GraphExplorer.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphExplorerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGraphExplorerApp

CGraphExplorerApp::CGraphExplorerApp()
{
...
// Единственный объект CGraphExplorerApp

CGraphExplorerApp theApp;


// Инициализация CGraphExplorerApp

BOOL CGraphExplorerApp::InitInstance()
{
